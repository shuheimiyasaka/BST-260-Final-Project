  ...
  sidebarLayout(
              ...
              position = "left",
                sidebarPanel(
                  ...
                  selectInput(inputId='emp_length', label='Employment length', choices=c('< 1 year'=0,'1 year'=1, '2 years'=2, '3 years'=3, '4 years'=4, '5 years'=5, '6 years'=6, '7 years'=7, '8 years'=8, '9 years'=9, '10+ years'=10)),
                  ...
                  checkboxInput(inputId='tot_coll_amt_gt0',label='Total collection amounts ever owed', value=1),
